...
def init_snowpack(STATIC):
    ...
    if (snowheight > 0.0):
        ...
        n_full_layers = int(snowheight / initial_snow_layer_heights)
        ...
        dT = (initial_upper_temperature - initial_lower_temperature) / (snowheight + glacier_height)
        ...
        layer_T = initial_upper_temperature - (dT * midpoint_depths)
        ...
        layer_T = np.concatenate((layer_T, initial_upper_temperature - (dT * midpoint_depths)))
    ...
    # ============= #
        ...
        dT = (initial_upper_temperature - initial_lower_temperature) / glacier_height
