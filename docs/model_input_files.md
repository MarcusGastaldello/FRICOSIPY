...
The [create_illumination_netcdf.py](https://github.com/MarcusGastaldello/FRICOSIPY/tree/main/utilities/utilities/create_ILLUMINATION/create_illumination_netcdf.py) utility program can create this file from an existing static file.
