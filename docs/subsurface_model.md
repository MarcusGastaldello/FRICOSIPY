...
??? "**$(i)$ Katsushima et al. (2009)**"
    ...
    \begin{cases} 
    \frac{2}{\pi \: d^2} \: \left[ 1.28e-8 + 4.22 \times 10^{-10} \: \left[ \frac{\phi_{\:w} \: \rho_{\:w}}{\rho} \right]^{3} \right], & \left[ \frac{\phi_{\:w} \: \rho_{\:w}}{\rho} \right] \leq 10 \: \% \\ 
    \frac{2.5 \times 10^{-4}}{d^2} \: \frac{1}{3600}, & \left[ \frac{\phi_{\:w} \: \rho_{\:w}}{\rho} \right] > 10 \: \% 
    \end{cases}
    $$
