...
turbulent_fluxes_method = 'default'   	          # Options: ['default','Essery04']
...
constant_fresh_snow_density = 300.              # (Constant - snow_density_method) Constant density of freshly fallen snow [kg m-3]
...
initial_snowheight = 10.                        # Initial snowheight [m]
...
initial_glacier_height = 10.0                   # Initial glacier height (without snowlayers) [m]
