...
snow_density_method = 'constant'                  # Options: ['constant','Vionnet12']
turbulent_fluxes_method = 'Essery04'   	          # Options: ['default','Essery04']
stability_correction = 'Ri'                       # Options: ['Ri','MO']
albedo_method = 'Bougamont05'                     # Options: ['Oerlemans98','Bougamont05']
...
snow_ice_threshold = 900.0                      # Pore close off density [kg m-3]
