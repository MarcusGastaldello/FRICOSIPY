...
# Output File:
output_netcdf = 'Output_Colle_Gnifetti_1999-2025_FRICOSIPY_V1_3_Test_NEW_LIGTENBERG.nc'
...
initial_timestamp =  '1999-01-01T00:00'  # (Datetime (yyyy-mm-ddThh:mm) , if unused - 'None')
